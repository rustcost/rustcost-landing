      ...
      <section className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
        <div className="mb-4 flex items-center justify-between">
          <h2 className="text-2xl font-extrabold text-gray-900 dark:text-white">
            {t("community.supporters.title", { defaultValue: "Supporters" })}
          </h2>
          <a
            href={t("community.supporters.applyLink", {
              defaultValue:
                "https://github.com/rustcost/rustcost/issues/new?title=Supporter%20Application&labels=sponsor",
            })}
            target="_blank"
            rel="noreferrer"
          ...
          >
            {t("community.supporters.add", { defaultValue: "Add your company" })}
          </a>
        </div>
